...
<div class="full-screen" style="background:#fcfcfc">
    <div class="container pt100 pb100">
        <div class="row w100">
            <div class="col-12">
                <h3 class="pl10">My Listings <a href="/add-listing" class="btn btn-secondary"> <i class="fas fa-plus"></i> &nbsp;Add Listing </a> </h3>
                <hr>
                
                <section class="features4 cid-sF28YHzl1m" id="features4-6" style="padding:0; background:none">
                    <div class="row mt-4">
                        <?php 
                            if($business->userBusinesses($userSession) == false){
                                echo " <div class='p20'> You do not have a listing yet. </div>";
                            } else {
                            foreach($business->userBusinesses($userSession) AS $biz){ 
                        ?>
