<?php 
    ...
    $catSlug = ltrim($_SERVER['REQUEST_URI'], "/category/");
...
<div class="full-screen" style="background:#fcfcfc">
    <div class="container pt100 pb100">
        <div class="row w100">
            <div class="col-12">
                <h3 class="pl10">Listings in <?php echo $category->getCategory($catSlug)['name']; ?> </h3>
                <hr>
                
                <section class="features4 cid-sF28YHzl1m" id="features4-6" style="padding:0; background:none">
                    <div class="row mt-4">
                        <?php 
                            if($business->categoryBusinesses($category->getCategory($catSlug)['id']) == false){
                                echo " <div class='p20'> We do not have listings in this category yet. </div>";
                            } else {
                            foreach($business->categoryBusinesses($category->getCategory($catSlug)['id']) AS $biz){ 
                        ?>
                            <div class="item features-image сol-12 col-md-6 col-lg-4">
                                <div class="item-wrapper">
                                    <div class="item-img">
                                        <a href="/<?php echo $biz['slug']; ?>" style="color:#333">
                                            <img src="<?php echo $rootURL.'assets/images/businesses/'.$biz['image']; ?>" alt="<?php echo $biz['name']; ?>" title="<?php echo $biz['name']; ?>">
                                        </a>
                                    </div>
